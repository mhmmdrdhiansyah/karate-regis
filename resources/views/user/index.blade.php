    ...
    <div class="card">
        ...
        <div class="card-body py-4">
            ...
            <div class="d-block d-lg-none">
                <style>
                    .u-card{background:#fff;border:1px dashed #e4e6ef;border-radius:8px;margin-bottom:10px;overflow:hidden}
                    .u-card-hd{padding:12px 14px;display:flex;align-items:center;gap:10px;cursor:pointer;-webkit-tap-highlight-color:transparent;user-select:none}
                    .u-card-hd:active{background:#f9fafb}
                    .u-card-av{width:42px;height:42px;border-radius:50%;overflow:hidden;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:.95rem}
                    .u-card-nm{flex:1;min-width:0;font-weight:700;font-size:.88rem;color:#3f4254;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
                    .u-card-em{font-size:.72rem;color:#b5b5c3;font-weight:600;margin-top:2px}
                    .u-card-bg{display:flex;flex-wrap:wrap;gap:4px;margin-top:2px}
                    .u-card-bg .badge{font-size:.6rem;padding:2px 6px;border-radius:4px}
                    .u-card-arr{flex-shrink:0;color:#b5b5c3;transition:transform .25s ease;font-size:.7rem}
                    .u-card.open .u-card-arr{transform:rotate(180deg)}
                    .u-card-bd{max-height:0;overflow:hidden;transition:max-height .3s cubic-bezier(.4,0,.2,1)}
                    .u-card.open .u-card-bd{max-height:500px}
                    .u-card-dt{padding:0 14px 12px}
                    .u-card-row{display:flex;justify-content:space-between;align-items:center;padding:7px 0;border-bottom:1px solid #f3f6f9}
                    .u-card-row:last-child{border-bottom:none}
                    .u-card-lbl{font-size:.72rem;color:#b5b5c3;font-weight:600}
                    .u-card-val{font-size:.78rem;color:#3f4254;font-weight:600;text-align:right;max-width:60%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
                    .u-card-acts{display:flex;gap:6px;padding:6px 14px 12px;border-top:1px dashed #e4e6ef}
                    .u-card-acts .btn{flex:1;font-size:.72rem;padding:6px 0;border-radius:6px;display:flex;align-items:center;justify-content:center;gap:4px}
                </style>
