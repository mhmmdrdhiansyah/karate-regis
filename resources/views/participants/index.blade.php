    ...
    <div class="card">
        ...
        <div class="card-body py-4">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @forelse ($participants as $participant)
                            <tr>
                                <td class="text-gray-500 text-center">{{ $participants->firstItem() + $loop->index }}</td>
                                <td>
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3" style="width:50px;height:50px">
                                        @if ($participant->photo)
                                            <img src="{{ Storage::url($participant->photo) }}"
                                                alt="{{ $participant->name }}" style="width:50px;height:50px;object-fit:cover" />
                                        @else
            ...
            <div class="d-block d-lg-none">
                <style>
                    .p-card{background:#fff;border:1px dashed #e4e6ef;border-radius:8px;margin-bottom:10px;overflow:hidden}
                    .p-card-hd{padding:12px 14px;display:flex;align-items:center;gap:10px;cursor:pointer;-webkit-tap-highlight-color:transparent;user-select:none}
                    .p-card-hd:active{background:#f9fafb}
                    .p-card-av{width:42px;height:42px;border-radius:50%;overflow:hidden;flex-shrink-0;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:.95rem}
                    .p-card-av img{width:100%;height:100%;object-fit:cover;border-radius:50%}
                    .p-card-nm{flex:1;min-width:0;font-weight:700;font-size:.88rem;color:#3f4254;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
                    .p-card-bg{display:flex;flex-wrap:wrap;gap:4px;margin-top:2px}
                    .p-card-bg .badge{font-size:.6rem;padding:2px 6px;border-radius:4px}
                    .p-card-arr{flex-shrink:0;color:#b5b5c3;transition:transform .25s ease;font-size:.7rem}
                    .p-card.open .p-card-arr{transform:rotate(180deg)}
                    .p-card-bd{max-height:0;overflow:hidden;transition:max-height .3s cubic-bezier(.4,0,.2,1)}
                    .p-card.open .p-card-bd{max-height:500px}
                    .p-card-dt{padding:0 14px 12px}
                    .p-card-row{display:flex;justify-content:space-between;align-items:center;padding:7px 0;border-bottom:1px solid #f3f6f9}
                    .p-card-row:last-child{border-bottom:none}
                    .p-card-lbl{font-size:.72rem;color:#b5b5c3;font-weight:600}
                    .p-card-val{font-size:.78rem;color:#3f4254;font-weight:600;text-align:right;max-width:60%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
                    .p-card-acts{display:flex;gap:6px;padding:6px 14px 12px;border-top:1px dashed #e4e6ef}
                    .p-card-acts .btn{flex:1;font-size:.72rem;padding:6px 0;border-radius:6px;display:flex;align-items:center;justify-content:center;gap:4px}
                </style>
