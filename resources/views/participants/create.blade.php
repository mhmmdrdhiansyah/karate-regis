<x-app-layout>
    ...
    <form action="{{ route('participants.store') }}" method="POST" id="kt_participant_form"
        ...
        <div class="card mb-5">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-1 fw-semibold fs-7">Pilih jenis peserta dan isi form sesuai data</span>
                </h3>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="fv-row mb-7">
                            ...
                            <div class="border rounded p-4 text-center">
                                <div class="w-175px h-225px mx-auto overflow-hidden rounded border d-flex align-items-center justify-content-center bg-light">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="border rounded p-3">
                                <div class="w-100 h-auto overflow-hidden rounded">
                                    <img src="{{ asset('assets/media/contoh-foto/contoh1.png') }}"
                                        alt="Contoh Foto" class="w-100 h-auto" />
                                </div>
                                <span class="text-muted fs-7 mt-2 d-block">Pastikan foto sesuai format di atas</span>
                            </div>
                        </div>
                    </div>
                    <!--end::Col Foto-->
                            ...
                            <div class="d-flex flex-wrap gap-5">
                                <label class="form-check form-check-sm form-check-custom form-check-solid">
                                    <input class="form-check-input" type="radio" name="type" value="athlete"
                                        {{ old('type', 'athlete') === 'athlete' ? 'checked' : '' }} id="type_athlete" />
